...
public class SacrificialStaff extends ItemStaff {
    ...
    public static void onItemTooltip(@Nonnull ItemTooltipEvent evt) {
        ...
        if (item instanceof SacrificialStaff) {
            evt.getToolTip().add(1, TextFormatting.DARK_GRAY + String.valueOf(TextFormatting.ITALIC) + I18n.format("item.sacrificial_staff.tooltip"));
        }
    }
