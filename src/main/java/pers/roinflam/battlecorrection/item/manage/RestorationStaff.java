...
public class RestorationStaff extends ItemStaff {
    ...
    public RestorationStaff(@Nonnull String name, @Nonnull CreativeTabs creativeTabs) {
    ...
    public static void onItemTooltip(@Nonnull ItemTooltipEvent evt) {
        ...
        if (item instanceof RestorationStaff) {
            evt.getToolTip().add(1, TextFormatting.DARK_GRAY + String.valueOf(TextFormatting.ITALIC) + I18n.format("item.restoration_staff.tooltip"));
        }
    }
